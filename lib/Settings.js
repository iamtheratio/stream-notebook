...
const DEFAULTS = {
    ...
    // Overlay placement. The notebook module renders at a fixed 400x570 and
    // positions itself bottom-left, which is small on a 1440p canvas and badly
    // placed on a vertical one. overlay.html applies these over the module rather
    // than editing it — notebook-overlay.js is shared with the upstream project
    // and has to stay byte-identical.
